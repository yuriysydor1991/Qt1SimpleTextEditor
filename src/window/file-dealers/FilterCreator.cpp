  ...
  */
  static constexpr const char *defaultFileFilter
    = "All files (*)\n"
      ...
      "*.rtf *.text *.manifest *.tsv *.pgw *.pod *.ascii *.xfd *.log *.pl *.report *.xmp *.smi *.reg "
      "*.las *.html5 *.ver *.yml *.application *.diz *.ffp *.mtx *.tce *.label *.dtd *.xsd *.linux *.xlf "
      "*.wer *.dbt *.smali *.aml *.att *.fpt *.nfo *.sbv *.lst *.bss *.full *.pdu *.drp *.ansi *.android "
      "*.extra *.mf *.gen *.err *.brf *.xy *.en *.ecsv *.sha1 *.us *.fsa *.tfw *.modd *.igy *.sdnf *.s19 "
      "*.ldf *.sfb *.eia *.zib *.bog *.strings *.ltx *.ipr *.srx *.ba1 *.lrc *.xdp *.ac *.ru *.rff *.mp3 "
      "*.xff *.annot *.xsl *.fr *.artask *.crash *.opml *.ion *.nt *.ans *.diskdefines *.resp *.alx *.wkf "
      "*.tt *.new *.lin *.ssa *.isi *.rus *.clg *.emulecollection *.readme *.utf8 *.uk *.rt *.mw *.vzm "
      "*.spx *.xslt *.adl *.s2k *.1st *.sha512 *.pjs *.rml *.lisp *.markdown *.desc *.oot *.tlx *.odc "
      "*.prn *.gnu *.clipping *.dea *.soap *.idt *.dqy *.ja *.pac *.fin *.bnx *.tdump *.not *.gbf *.ger "
      "*.bna *.xdl *.skv *.spec *.lnc *.rtx *.mit *.pln *.blm *.lyr *.coo *.rest *.cof *.efm *.srt *.dk "
      "*.textile *.dpv *.vhdl *.lwd *.klg *.isr *.bcr *.pcl *.vfk *.zed *.edml *.st1 *.pla *.enf *.etf "
      "*.map *.plk *.notes *.bpdx *.cd2 *.$00 *.dok *.ocr *.usf *.zhp *.mkdn *.user *.asp *.ltr *.crwl "
      "*.nbr *.opc *.pvw *.tcm *.chord *.lxfml *.jeb *.ort *.etx *.txt *.wst *.jtx *.bln *.first *.uhtml "
      "*.dat *.lst *.ctl *.jp1 *.it *.prc *.mib *.bsdl *.hvc *.txe *.frm *.rea *.ext *.prr *.$01 *.phr "
      "*.de *.vcf *._me *.dne *.sami *.faq *.lo_ *.wsh *.txt *.dkz *.vw *.text *.vhd *.hhc *.dfe *.pmo "
      " *.tle *.aqt *.nna *.uni *.xwp *.ssf *.gthr *.htx *.htmls *.$02 *.ctl *.usg *.tab *.bdp *.ddd "
      "*.qdt *.kor *.vers *.ckn *.inuse *.adw *.ttbl *.charset *.x70 *.maxfr *.ltt *.dmr *.osn *.unx "
      "*.kch *.txk *.bep *.guide *.aprj *.89t *.dectest *.assoc *.blw *.x20 *.x80 *.nlc *.bea *.map *.qud "
      "*.xc0 *.skcard *.txh *.awa *.q&a *.tx8 *.kix *.crd *.thp *.txd *.now *.bbs *.mcw *.mdwn *.mss *.utx "
      "*.dp *.lue *.hs *.luf *.big5 *.soundscript *.mathml *.wn *.omn *.hz *.wtx *.ttpl *.tph *.$04 *.iem "
      "*.rtl *.fnx *.$ol *.sk *.hhs *.vkp *.mkd *.hlm *.zw *.tab *.tnef *.ttxt *.igv *.pc5 *.snw *.lst *.p3x "
      "*.cdt *.xsr *.psb *.gpl *.ill *.clix *.lst *.csassembly *.trt *.bdn *.txa *.linx *.ttf *.rst *.seq *.spg "
      "*.fff *.jam *.utxt *.hpm *.mar *.nmbd *.mdown *.mpl *.vxml *.ctx *.oh *.mdle *.u3i *.001 *.tmx *.tdf "
      "*.unauth *.mdtext *.dfm *.zxe *.tx? *.smf *.$o1 *.abt *.trn *.dii *.gtx *.pfs *.jis *.adt *.asl *.lst "
      "*.big *.adiumlog *.jam *.es *.x60 *.idx *.cc *.plf *.wrd *.openbsd *.cas *.cil *.hdr *.ted *.mez *.82t "
      "*.nokogiri *.bt *.oogl *.cif *.fil *.curl *.nwctxt *.csmanifest *.dcd *.la *.inc *.xhtm *.pd *.tm *.lay "
      "*.man *.flr *.$05 *.mtx *.bel *.adiumhtmllog *.v2t *.bk *.inc *.jss *.xwp *.dsml *.tgf *.tbd *.t *.xyz "
      "*.dsc *.spn *.mtxt *.xyp *.lyt *.vna *.me *.bad *.jam *.t2t *.sms *.ojp *.text *.pcc *.vsmproj *.panic "
      "*.tlb *.mdtxt *.ctf *.dce *.axt *.ctd *.awb *.9xt *.vis *.id31 *.nclk *.x90 *.awh *.ion *.cho *.bdr "
      "*.vw3 *.rzn *.euc *.idc *.tte *.cag *.tmprtf *.pvj *.7 *.sen *.bbxt *.fra *.s2s *.mpsub *.pml *.cli "
      "*.pt3 *.syn *.xyw *.tlx *.osi *.pro *.bzw *.kahl *.set *.hlx "
      " *.8 *.gdt *.rzk *.92t *.id32 *.lst *.apx *.igtx *.pbd *.uax *.fon *.xy3 *.tpl *.vet *.stq *.cascii *.cs "
      "*.awp *.sct *.box *.inc *.box *.rbdf *.8xt *.awd *.hp8 *.rel *.sgp *.hsk *.ivp *.abl *.zanebug *.spa *.nvgp "
      "*.ion *.txa *.xd0 *.fmr *.xb0 *.npdt *.gluaw *.k2edoc *.hm12 *.cff *.des *.ini "
      ...
      " *.jsc *.mac *.tcl *.install *.resources *.smali *.cls *.mwp *.cc *.java "
      ...
      " *.seam *.rml *.proto *.lisp *.less *.bcp *.obj *.pag *.egg-info *.rule "
      " *.cbl *.dep *.isu *.lss *.vb *.wsdl *.ppa *.vd *.dev *.build "
      " *.bb *.jl *.txml *.bxml *.odc *.lol *.bbc *.scb *.rh *.cobol "
      " *.gml *.datasource *.jsdtscope *.cml *.jbi *.ide *.pdo *.aidl *.cg *.gnt "
      ...
      " *.dproj *.tru *.amw *.param *.factorypath *.jade *.tmh *.wml *.pch *.kv "
      ...
      " *.fountain *.rproj *.cos *.pxml *.pli *.din *.xn *.kst *.cpz *.svn-base "
      ...
      " *.jsonp *.xjb *.poc *.fsi *.rts *.xul *.irobo *.cba *.sass *.devpak *.autosave "
      " *.lba *.dot *.viw *.irc *.mfl *.odl *.rws *.thor *.gls *.htr "
      " *.scm *.dgml *.clojure *.cla *.ipy *.mediawiki *.bur *.wsc *.mat *.wfs "
      ...
      " *.dto *.dic *.hic *.agi *.lnx *.bet *.xin *.sqlproj *.appxmanifest *.fxl "
      ...
      " *.xfm *.lhs *.prg *.makefile *.ppo *.ucb *.sas *.vstemplate *.fbp *.zero "
      " *.qsc *.vbproj *.oqy *.vrp *.jsfl *.cls *.atmn *.kodu *.jcl *.rub "
      " *.lnp *.ftn *.actionscript *.appxsym *.slim *.bbf *.ncx *.tlh *.fgb *.chef "
      " *.csh *.hse *.lmv *.rbw *.v *.pnproj *.jtb *.oppo *.rgs *.alan "
      " *.owl *.cfi *.sno *.xnf *.classdiagram *.ipch *.vcproj *.smw *.xda *.hei "
      " *.ev3p *.npi *.ba_ *.psc1 *.okm *.pba *.phs *.tur *.myapp *.cplist "
      " *.git *.plog *.ccproj *.cls *.cel *.jex *.gek *.psml *.lsh *.rmn "
      " *.asmx *.win32manifest *.xtxt *.ck *.afb *.cfs *.appxupload *.jgs *.xml-log *.ttcn "
      ...
      " *.vdproj *.pspscript *.rnw *.m4 *.qpf *.iss *.grxml *.ogs *.ebs2 *.bsml "
      ...
      " *.jsb *.bin_ *.c__ *.rpres *.jbp *.hxproj *.anjuta *.idle *.fcgi *.exw "
      " *.nmk *.sbh *.kix *.ogl *.thml *.ywl *.itmx *.hbx *.obr *.hrl "
      " *.mc *.goc *.acgi *.simba *.mss *.pro *.cfml *.tzs *.tcsh *.entitlements "
      ...
      " *.ass *.jcm *.4gl *.kit *.xrc *.wdproj *.wam *.vsixmanifest *.ajm *.b2d "
      " *.tla *.dsb *.licenses *.bufferedimage *.sbml *.xblr *.cord *.dcproj *.ebm *.map "
      " *.mmb *.neko *.mmh *.19 *.mln *.pro *.mfps *.daemonscript *.rake *.image "
      " *.hxml *.dcf *.axb *.reb *.jsxinc *.a8s *.playground *.pfa *.ldz *.ts0 "
      " *.yxx *.graphmlz *.ahtml *.pjx *.scar *.komodo *.ss *.11 *.javajet "
      " *.msh1xml *.rqb *.aah *.elc *.lamp *.lpr *.udf *.creole *.po *.ezg *.vala "
      " *.a2x *.dsym *.pp1 *.scriptterminology *.confluence *.rqc *.pwo *.xojo_binary_project *.p4a *.asp "
      " *.configure *.uih *.jmk *.mdex *.vgc *.genmodel *.xoml *.cgvp *.mdf *.csml "
      " *.mmbas *.a66 *.napj *.kbs *.xqr *.eek *.bxb *.exp *.csi *.jscript "
      " *.slackbuild *.a3x *.zcode *.deb *.dfm *.cr *.cu *.applescript *.xba *.a "
      " *.as3 *.wspd *.dsp *.xje *.hrh *.inc *.fpc *.ccbjs *.dwp *.xbap "
      " *.ssml *.nunit *.php6 *.tsc *.has *.capfile *.njk *.zpk *.wdk *.generictest "
      " *.triple-s *.clw *.hhh *.d2j *.irbrc *.fsb *.bcf *.sb *.litcoffee *.mlsxml "
      " *.lbj *.bdsproj *.csm *.builder *.xmla *.fxh *.defi *.f77 *.fbp6 *.xcodeproj "
      " *.dbpro *.borland *.s2s *.mrm *.pem *.dsq *.xbl *.dbproj *.ccp *.kml "
      " *.js *.plc *.h6h *.ecorediag *.ls3proj *.pl5 *.lasso *.pgm *.~df *.iss "
      ...
      " *.pgml *.actx *.ps2xml *.tcx *.sit *.vc *.hh *.mfcribbon-ms *.oplm *.sxv "
      " *.qlc *.dsym *.b *.cap *.fxcproj *.jpx *.hpp *.mtp *.pike *.snp "
      " *.kl3 *.apg *.docstates *.drc *.abs *.textile *.abl *.gml *.phpproj *.vic "
      ...
      " *.wsd *.androidproj *.wscript *.asproj *.forth *.mpd *.osas *.sym *.owd *.ff "
      " *.fsf *.h-- *.asbx *.m4x *.nxc *.zcls *.odh *.rpprj *.mingw *.svc "
      " *.mbtemmplate *.csdproj *.sf *.asr *.dts *.dro *.dwt *.gsb *.pds *.axe "
      " *.rtml *.m *.mingw32 *.rb *.ags *.sqldataprovider *.ptb *.cs *.pde *.cb "
      ...
      " *.cus *.bpt *.tml *.pbxscript *.fsproj *.baz *.deployproj *.smd *.mvc *.bil "
      " *.sc *.xbd *.rapc *.rng *.alx *.tu *.erb *.tcl *.csf *.csview "
      " *.mcr *.car *.iadpage *.wpm *.htd *.awl *.vmx *.kdevprj *.lit *.tatxtt "
      " *.anm *.vc4 *.ms *.mp? *.mem *.bmml *.plac *.h++ *.msym *.dpk "
      " *.vdm *.92x *.xmta *.wx *.md *.kb *.rsym *.clu *.tag *.seman "
      " *.tpl *.rex *.msm *.cxt *.wsil *.isym *.3dfbat *.scro *.stuffit11task *.aba "
      " *.mml *.ll *.idb *.mix *.orc *.v4s *.scp *.sbi *.qcf *.cprr "
      " *.bml *.cap *.fsl *.ods *.tem *.d *.atl *.gs *.rtk *.mdf "
      " *.radius *.tom *.pbxbtree *.aut *.db2 *.tlv *.nsconfig *.ic *.api_filters *.artproj "
      " *.xbc *.xlm4 *.asp+ *.fsscript *.transcriptstyle *.adt *.nlpj *.fwaction *.sid *.alb "
      " *.bsd *.nunj *.catvbs *.spk *.w32 *.tbasic *.bks *.nopj *.jsl *.ipproj "
      " *.egg *.pml *.wsym *.qpr *.scr *.mm *.fp *.ds *.as? *.e "
      " *.mpkt *.perlctrl *.unx *.tgproj *.psl *.pxt *.nsx *.xweb4asax *.glf *.box "
      ...
      " *.efss *.tokend *.sda *.xsc *.tracwiki *.xojo_project *.h5bprj *.spt *.ch *.dif "
      " *.scm *.csp *.db *.vad *.cvsrc *.sfp *.xojo_xml_project *.vc2 *.smw *.irev "
      " *.fpp *.sps *.st *.sw *.gsym *.cva *.codasite *.msct *.celx *.tml "
      " *.ook *.scriptsuite *.msl *.atp *.msdev *.prm *.m *.sqljet *.fdm *.nunjucks "
      ...
      " *.bbproject *.qml *.dsl *.zasm *.djg *.lwmw *.dadx *.gbap *.cmp *.rguninst "
      " *.adiumscripts *.flm *.pwn *.erubis *.mc *.t *.wmc *.nqc *.wixout *.tps "
      " *.csp *.netproject *.ifos *.wowproj *.wdx9 *.il *.nppj *.sim *.vc1 *.amf "
      " *.icl *.boo *.tql *.pcs *.tpx *.xweb4stm *.dgscript *.iadstyle *.l1i *.rcs "
      " *.jomproj *.rbc *.dil *.xweb4htt *.zfs *.opt *.vspolicy *.wix *.sml *.xmljet "
      ...
      " *.qt3d *.pbx5script *.bli *.slogo *.ihex *.umlclass *.ufdl *.rxs *.y *.graphql "
      " *.m2 *.clx *.pri *.prx *.gnumakefile *.lwa *.db2tbl *.aso *.nms *.startlet "
      " *.ebs *.agls *.tbasicx *.txc *.adt *.zms *.svx *.lpr *.ss *.das "
      " *.exprwdxsl *.xds *.kg *.xmsc *.sls *.kt3 *.cp *.tpt *.ndpvs *.perlsvc "
      " *.wsc *.xlm3 *.pyproj *.zsrc *.xweb3master *.exc *.for *.ridl *.issuite *.ssc "
      " *.xscscpt *.tlc *.cryproject *.idl *.nmpj *.qf *.emakerfile *.db2vw *.lgt *.fil "
      " *.pxi *.ocamlmakefile *.l *.82p *.ac *.ti *.sbproj *.cbs *.sjava *.mdsp "
      " *.cesf *.tig *.iadaction *.iadproj *.djconf *.xmap *.aifb *.propertiesjet *.hevbs *.dbheader "
